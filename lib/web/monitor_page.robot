...
#41
App Details - Logical Operator Details - Change operator properties
...
#42
App Details - Logical Operator Details - Navigate to operator's Container
    ${app_name}=  convert to string  MobileDemo        #Make sure only two spaces after "string"
    ${operator_name}=  convert to string  Receiver     #Make sure only two spaces after "string"
    GO TO PAGEM  Monitor  Cluster Overview
    wait until page contains   ${app_name}  timeout=20s
...
#43
App Details - Logical Operator Details - Navigate to Physical operator
    ${app_name}=  convert to string  MobileDemo        #Make sure only two spaces after "string"
    ${operator_name}=  convert to string  Receiver     #Make sure only two spaces after "string"
    GO TO PAGEM  Monitor  Cluster Overview
    wait until page contains   ${app_name}  timeout=20s
...
#44
App Details - Logical Operator Details - Record sample
    ${app_name}=  convert to string  MobileDemo         #Make sure only two spaces after "string"
    ${operator_name}=  convert to string  Receiver      #Make sure only two spaces after "string"
    GO TO PAGEM  Monitor  Cluster Overview
    wait until page contains   ${app_name}  timeout=20s
...
#46
App Details - Streams details - operator links
    ${app_name}=  convert to string  MobileDemo         #Make sure only two spaces after "string"
...
#47
App Details - Streams details - Search & Sort
    ${app_name}=  convert to string  MobileDemo         #Make sure only two spaces after "string"
...
#48
App Details - Metric Chart details
    ${app_name}=  convert to string  MobileDemo         #Make sure only two spaces after "string"
...
#49
App Details - Metric Chart details2
    ${app_name}=  convert to string  MobileDemo         #Make sure only two spaces after "string"
...
#50
App Details - Physical Operators details
    ${app_name}=  convert to string  MobileDemo         #Make sure only two spaces after "string"
    ${toggle}=  convert to string  tuplesEmittedPSMA
    GO TO PAGEM  Monitor  Cluster Overview
    wait until page contains   ${app_name}  timeout=20s
...
#51
App Details - Physical Operators - Search & Sort
    ${app_name}=  convert to string  MobileDemo         #Make sure only two spaces after "string"
    ...
    #latency
     #click element  xpath=/html/body/div[2]/div/div/div/div[2]/div/div[2]/div[2]/div/div[2]/div/div/div[2]/table/thead/tr[1]/th[3]
    click element  xpath=/html/body/div[2]/div/div/div/div[2]/div/div[2]/div[2]/div/div[2]/div/div/div[2]/table/thead/tr[1]/th[14]
    ${ids}=  create list
    : FOR    ${INDEX}    IN RANGE    1    ${count_str}+1
    \    Log    ${INDEX}
...
#52
App Details - Physical Operators - Logical Operator Name link
    ${app_name}=  convert to string  MobileDemo        #Make sure only two spaces after "string"
    ${operator_name}=  convert to string  Receiver     #Make sure only two spaces after "string"
    GO TO PAGEM  Monitor  Cluster Overview
    wait until page contains   ${app_name}  timeout=20s
...
#53
App Details - Physical Operators - Container link
    ${app_name}=  convert to string  MobileDemo        #Make sure only two spaces after "string"
...
#54
App Details - Physical Operators - Record a Sample (default)
    ${app_name}=  convert to string  MobileDemo        #Make sure only two spaces after "string"
    ${operator_name}=  convert to string  QueryLocation     #Make sure only two spaces after "string"
    GO TO PAGEM  Monitor  Cluster Overview
    wait until page contains   ${app_name}  timeout=20s
...
*** Test Cases ***
#58
App Details - Physical Operators - inspect
    ${app_name}=  convert to string  MobileDemo        #Make sure only two spaces after "string"
    ${operator_id}=  convert to string  00003     #Make sure only two spaces after "string"
    GO TO PAGEM  Monitor  Cluster Overview
    wait until page contains   ${app_name}  timeout=20s
    click element  xpath=//a[contains(text(),"${app_name}")]/../a
    wait until page contains   ${app_name}  timeout=20s
...
#59
App Details - Physical Operator Details - Breadcrumb
    ${app_name}=  convert to string  MobileDemo        #Make sure only two spaces after "string"
    ${operator_name}=  convert to string  QueryLocation     #Make sure only two spaces after "string"
    GO TO PAGEM  Monitor  Cluster Overview
    wait until page contains   ${app_name}  timeout=20s
...
#60
App Details - Physical Operator Details
    ${app_name}=  convert to string  MobileDemo        #Make sure only two spaces after "string"
    ${operator_name}=  convert to string  QueryLocation     #Make sure only two spaces after "string"
    GO TO PAGEM  Monitor  Cluster Overview
    wait until page contains   ${app_name}  timeout=20s
...
#61
App Details - Physical Operator Details - Navigate to Logical operator details
    ${app_name}=  convert to string  MobileDemo        #Make sure only two spaces after "string"
    ${operator_name}=  convert to string  QueryLocation     #Make sure only two spaces after "string"
    GO TO PAGEM  Monitor  Cluster Overview
    wait until page contains   ${app_name}  timeout=20s
...
#62
App Details - Physical Operator Details - Navigate to container details
    ${app_name}=  convert to string  MobileDemo        #Make sure only two spaces after "string"
    ${operator_name}=  convert to string  QueryLocation     #Make sure only two spaces after "string"
    GO TO PAGEM  Monitor  Cluster Overview
    wait until page contains   ${app_name}  timeout=20s
...
#63
App Details - Physical Operator Details - Container logs
    ${app_name}=  convert to string  MobileDemo        #Make sure only two spaces after "string"
    ${operator_name}=  convert to string  QueryLocation     #Make sure only two spaces after "string"
    GO TO PAGEM  Monitor  Cluster Overview
    wait until page contains   ${app_name}  timeout=20s
...
#64
App Details - Physical Operator Details - Port details
    ${app_name}=  convert to string  MobileDemo        #Make sure only two spaces after "string"
    ${port_name}=  convert to string  outputPort     #Make sure only two spaces after "string"
    GO TO PAGEM  Monitor  Cluster Overview
    wait until page contains   ${app_name}  timeout=20s
    click element  xpath=//a[contains(text(),"${app_name}")]/../a
    wait until page contains   ${app_name}  timeout=20s
...
#65
App Details - Physical Operator Details - Container History - ID
    ${app_name}=  convert to string  MobileDemo        #Make sure only two spaces after "string"
    ${port_name}=  convert to string  in     #Make sure only two spaces after "string"
    GO TO PAGEM  Monitor  Cluster Overview
    wait until page contains   ${app_name}  timeout=20s
    click element  xpath=//a[contains(text(),"${app_name}")]/../a
    wait until page contains   ${app_name}  timeout=20s
...
#66
App Details - Physical Operator Details - Container History - logs
    ${app_name}=  convert to string  MobileDemo        #Make sure only two spaces after "string"
    ${operator_name}=  convert to string  QueryLocation     #Make sure only two spaces after "string"
    GO TO PAGEM  Monitor  Cluster Overview
    wait until page contains   ${app_name}  timeout=20s
...
#67
App Details - Physical Operator Details - Search operator properties
    ${app_name}=  convert to string  MobileDemo        #Make sure only two spaces after "string"
    ${operator_name}=  convert to string  QueryLocation     #Make sure only two spaces after "string"
...
#68
App Details - Containers - Details
    ${app_name}=  convert to string  MobileDemo        #Make sure only two spaces after "string"
    ${operator_name}=  convert to string  QueryLocation     #Make sure only two spaces after "string"
    GO TO PAGEM  Monitor  Cluster Overview
    wait until page contains   ${app_name}  timeout=20s
...
#70
App Details - Containers - Search & Sort
    ${app_name}=  convert to string  MobileDemo        #Make sure only two spaces after "string"
    ${operator_name}=  convert to string  QueryLocation     #Make sure only two spaces after "string"
    ${id-1}  convert to string  2
    ${status}  convert to string  ACT
    ...
    ${free_mem}=   get substring  ${free_mem}  1
    ${count}=  get matching xpath count  xpath=/html/body/div[2]/div/div/div/div[2]/div/div[2]/div[3]/div/div[2]/div/div/div[2]/div/table/tbody[3]//tr[contains(text()," ")]/../tr
    ${count_str}=  convert to string  ${count}
...
#71
App Details - Containers - operators link
    ${app_name}=  convert to string  MobileDemo        #Make sure only two spaces after "string"
    ${operator_name}=  convert to string  QueryLocation     #Make sure only two spaces after "string"
    GO TO PAGEM  Monitor  Cluster Overview
    wait until page contains   ${app_name}  timeout=20s
...
#72
App Details - Containers - Single Container options
    ${app_name}=  convert to string  MobileDemo        #Make sure only two spaces after "string"
    ${operator_name}=  convert to string  QueryLocation     #Make sure only two spaces after "string"
    GO TO PAGEM  Monitor  Cluster Overview
    wait until page contains   ${app_name}  timeout=20s
...
#73
App Details - Containers - Multiple Container options
    ${app_name}=  convert to string  MobileDemo        #Make sure only two spaces after "string"
    ${operator_name}=  convert to string  QueryLocation     #Make sure only two spaces after "string"
    GO TO PAGEM  Monitor  Cluster Overview
    wait until page contains   ${app_name}  timeout=20s
...
#74
App Details - Containers - select active
    ${app_name}=  convert to string  MobileDemo        #Make sure only two spaces after "string"
    ${operator_name}=  convert to string  QueryLocation     #Make sure only two spaces after "string"
    GO TO PAGEM  Monitor  Cluster Overview
    wait until page contains   ${app_name}  timeout=20s
...
#75
App Details - Containers - select all active but app master
    ${app_name}=  convert to string  MobileDemo        #Make sure only two spaces after "string"
    ${operator_name}=  convert to string  QueryLocation     #Make sure only two spaces after "string"
    GO TO PAGEM  Monitor  Cluster Overview
    wait until page contains   ${app_name}  timeout=20s
...
#76
App Details - Containers - retrieve killed
    ${app_name}=  convert to string  MobileDemo        #Make sure only two spaces after "string"
    ${operator_name}=  convert to string  QueryLocation     #Make sure only two spaces after "string"
    GO TO PAGEM  Monitor  Cluster Overview
    wait until page contains   ${app_name}  timeout=20s
...
#77
App Details - Containers - AppMaster logs
    ${app_name}=  convert to string  MobileDemo        #Make sure only two spaces after "string"
    ${operator_name}=  convert to string  QueryLocation     #Make sure only two spaces after "string"
    GO TO PAGEM  Monitor  Cluster Overview
    wait until page contains   ${app_name}  timeout=20s
...
#78
App Details - Containers - logs
    ${app_name}=  convert to string  MobileDemo        #Make sure only two spaces after "string"
    ${operator_id}=  convert to string  0003     #Make sure only two spaces after "string"
    GO TO PAGEM  Monitor  Cluster Overview
    wait until page contains   ${app_name}  timeout=20s
    click element  xpath=//a[contains(text(),"${app_name}")]/../a
    wait until page contains   ${app_name}  timeout=20s
...
#79
App Details - Containers - AppMaster stackTrace
    ${app_name}=  convert to string  MobileDemo        #Make sure only two spaces after "string"
...
#80
App Details - Containers - stackTrace
    ${app_name}=  convert to string  MobileDemo        #Make sure only two spaces after "string"
    ${operator_id}=  convert to string  00003     #Make sure only two spaces after "string"
    GO TO PAGEM  Monitor  Cluster Overview
    wait until page contains   ${app_name}  timeout=20s
